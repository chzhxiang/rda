...
import com.rda.core.io.UnsafeByteArrayInputStream;
import com.rda.core.io.UnsafeByteArrayOutputStream;
...
public class Bytes {
	...
	public static byte[] unzip(byte[] bytes) throws IOException {
		...
		try {
			IOUtils.copyLarge(is, bos, new byte[DEFAULT_BUFFER_SIZE]);
			return bos.toByteArray();
		} finally {
			is.close();
			bis.close();
