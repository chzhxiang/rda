package com.rda.mybatis.interceptors.rw;
...
import com.rda.mybatis.utils.RdaPlugin;
...
public class RwInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (conn instanceof ConnectionProxy) {
			...
			if (RoutingStatementHandler.class.isAssignableFrom(target.getClass())) {
	...
	public Object plugin(Object target) {
		...
		return RdaPlugin.wrap(target, this);
	}
