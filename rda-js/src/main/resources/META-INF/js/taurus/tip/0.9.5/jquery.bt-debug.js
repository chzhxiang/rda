...
*/
define("taurus/tip/0.9.5/jquery.hoverIntent-debug", [], function(require){return function($){
var jQuery = $;
...
define("taurus/tip/0.9.5/jquery.bt-debug", ["./jquery.hoverIntent-debug", "taurus/bgiframe/2.1.2/jquery.bgiframe-debug"], function(require){return function($){ 
	require('./jquery.hoverIntent-debug.js')($);
